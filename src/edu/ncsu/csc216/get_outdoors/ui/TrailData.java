...
public class TrailData implements Data {
     ...
     * @param trailName name of the trial 
     * @param closedForMaintenance if close for maintenance
     * @param snow snow fall
     * @param distance distance in a given trail 
     * @param difficulty difficulty of the trail
     * @param activities activities within the trail
     */
